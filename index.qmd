...
<a href="numeralia_advc/numeralia_advc" target="_blank">Ver Numeralia ADVC (Sept2024)</a>
...
.tg {
    ...
    width: 100%;
    max-width: 100%;
    table-layout: auto; /* Permite que las columnas cambien de tamaño según el contenido */
}
...
leaflet() %>%
  ...
  addPolygons(
    ...
    popup = ~paste("<b>",ENTIDAD,"</b>",
      ...
      # paste("<strong>Estado:</strong>", ENTIDAD, "<br>",
      #              "<strong>Superficie ANP Total:</strong>", superficie_total_estado, "ha")
  ...
  #capa anp
    ...
    popup = ~paste("<strong>ANP:</strong>", NOMBRE, "<br>",
     ...
     highlightOptions = highlightOptions(
      weight = 3,
      color = "black",    # Color del borde al hacer hover
      fillOpacity = 0.7,  # Cambiar la opacidad
      bringToFront = TRUE
    )
  ) %>%

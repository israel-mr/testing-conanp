...
ambientes <- data.frame(
  ...
  Superficie = c(sum(resumen_superficies$superficie_t_total), 
...
ambientes$hover_text <- paste(c(
            paste0(notas_terrestres,
                   "<br>Superficie: ",
                   "<b>",scales::comma(ambientes$Superficie[1]),".19</b>"," ha", 
            ...
            paste0(notas_marinos, 
                   "<br>Superficie: ", 
                   "<b>",scales::comma(ambientes$Superficie[2]),".39</b>", " ha",
                   "<br>Porcentaje del total protegido: ",
...
#tb_vegetacion=tb_vegetacion[-1,] 


tb_vegetacion <- tb_vegetacion[order(-tb_vegetacion$surface), ]

tb_vegetacion$hover_text <- paste("<b>",vegetacion$type,"</b>",
  "<br>Superficie en ANP:", "<b>",scales::comma(vegetacion$surface),"</b>", "ha",# vegetacion$Superficie_ANP,
                               "<br>Porcentaje en ANP Federales:", "<b>",vegetacion$percentage," % </b>")
